...
def write_latex_report(
    ...
    body = (
        ...
        "Foundation models for time-series forecasting have recently demonstrated strong "
        ...
        "high-volatility asset price prediction. "
        ...
        + ("(iii)~\\emph{ICF (inference-only)}, and (iv)~\\emph{ICF (trained)} continued pretraining.\n"
           if has_icf_trained else
           "(iii)~\\emph{ICF (inference-only)}.\n")
        + "\n"
        "\n"
        "\\section{Methods}\n"
        "\n"
