...
"""Utilities for Monash extended benchmarks.

Adapted from v1/experiments/extended_benchmarks/utils.py for standalone use.
...
class ExperimentHandler:
  ...
  def __init__(
    ...
    # get_seasonality() returns 1 for freq='D', override this to 7.
    if self.freq == "D":
      self.seasonality = 7
    else:
  ...
  def test_df(self) -> pd.DataFrame:
    ...
    # Make sure that only the first backtest window is used for evaluation
